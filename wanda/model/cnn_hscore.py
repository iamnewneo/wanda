...
class WandaHSCNN(pl.LightningModule):
    def __init__(self):
        ...
        self.cnn1 = nn.Conv2d(in_channels=3, out_channels=16, kernel_size=9, stride=1)
        self.relu1 = nn.ReLU()

        # Max pool 1
        self.maxpool1 = nn.MaxPool2d(kernel_size=3)

        self.cnn2 = nn.Conv2d(in_channels=16, out_channels=8, kernel_size=9, stride=1)
        self.relu2 = nn.ReLU()

        self.maxpool2 = nn.MaxPool2d(kernel_size=3)

        # Fully connected 1 (readout)
        self.fc1 = nn.Linear(3872, 15)
